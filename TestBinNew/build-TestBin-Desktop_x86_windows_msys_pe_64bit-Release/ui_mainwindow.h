...
public:
    ...
    QLabel *label_7;
    QTextBrowser *textBrowser_ShowValue;
    QLabel *label_range;
    QWidget *horizontalLayoutWidget_2;
    QHBoxLayout *horizontalLayout_8;
    QTextEdit *RecvTextEdit;
    QTextEdit *SendTextEdit;
    QPushButton *ChangeRange;
    QMenuBar *menuBar;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(932, 587);
        centralWidget = new QWidget(MainWindow);
        centralWidget->setObjectName(QString::fromUtf8("centralWidget"));
        layoutWidget = new QWidget(centralWidget);
        layoutWidget->setObjectName(QString::fromUtf8("layoutWidget"));
        layoutWidget->setGeometry(QRect(230, 370, 691, 31));
        ...
        recvcheckBox->setObjectName(QString::fromUtf8("recvcheckBox"));
        ...
        timesendcheckBox->setObjectName(QString::fromUtf8("timesendcheckBox"));
        ...
        layoutWidget1->setGeometry(QRect(10, 10, 211, 481));
        ...
        uartbox = new QComboBox(layoutWidget1);
        uartbox->setObjectName(QString::fromUtf8("uartbox"));
        ...
        databox = new QComboBox(layoutWidget1);
        ...
        stopbox = new QComboBox(layoutWidget1);
        ...
        nonebox = new QComboBox(layoutWidget1);
        nonebox->addItem(QString());
        nonebox->setObjectName(QString::fromUtf8("nonebox"));
        ...
        RefreshUart = new QPushButton(layoutWidget1);
        RefreshUart->setObjectName(QString::fromUtf8("RefreshUart"));
        ...
        OpenUart = new QPushButton(layoutWidget1);
        OpenUart->setObjectName(QString::fromUtf8("OpenUart"));
        OpenUart->setMinimumSize(QSize(20, 31));
        OpenUart->setFont(font3);

        verticalLayout_2->addWidget(OpenUart);

        CloseUart = new QPushButton(layoutWidget1);
        CloseUart->setObjectName(QString::fromUtf8("CloseUart"));
        CloseUart->setMinimumSize(QSize(0, 31));
        CloseUart->setFont(font3);

        verticalLayout_2->addWidget(CloseUart);

        SendDataFile = new QPushButton(layoutWidget1);
        SendDataFile->setObjectName(QString::fromUtf8("SendDataFile"));
        SendDataFile->setMinimumSize(QSize(0, 31));
        SendDataFile->setFont(font3);

        verticalLayout_2->addWidget(SendDataFile);

        SaveRecvDataFile = new QPushButton(layoutWidget1);
        SaveRecvDataFile->setObjectName(QString::fromUtf8("SaveRecvDataFile"));
        SaveRecvDataFile->setMinimumSize(QSize(0, 31));
        SaveRecvDataFile->setFont(font3);

        verticalLayout_2->addWidget(SaveRecvDataFile);

        ClearRecvButton = new QPushButton(layoutWidget1);
        ...
        graphicsView->setGeometry(QRect(230, 10, 691, 311));
        horizontalLayoutWidget = new QWidget(centralWidget);
        horizontalLayoutWidget->setObjectName(QString::fromUtf8("horizontalLayoutWidget"));
        horizontalLayoutWidget->setGeometry(QRect(230, 330, 361, 31));
        ...
        textBrowser_ShowValue = new QTextBrowser(horizontalLayoutWidget);
        textBrowser_ShowValue->setObjectName(QString::fromUtf8("textBrowser_ShowValue"));

        horizontalLayout_7->addWidget(textBrowser_ShowValue);

        label_range = new QLabel(horizontalLayoutWidget);
        label_range->setObjectName(QString::fromUtf8("label_range"));

        horizontalLayout_7->addWidget(label_range);

        horizontalLayoutWidget_2 = new QWidget(centralWidget);
        horizontalLayoutWidget_2->setObjectName(QString::fromUtf8("horizontalLayoutWidget_2"));
        horizontalLayoutWidget_2->setGeometry(QRect(230, 410, 691, 87));
        horizontalLayout_8 = new QHBoxLayout(horizontalLayoutWidget_2);
        horizontalLayout_8->setSpacing(6);
        horizontalLayout_8->setContentsMargins(11, 11, 11, 11);
        horizontalLayout_8->setObjectName(QString::fromUtf8("horizontalLayout_8"));
        horizontalLayout_8->setContentsMargins(0, 0, 0, 0);
        RecvTextEdit = new QTextEdit(horizontalLayoutWidget_2);
        RecvTextEdit->setObjectName(QString::fromUtf8("RecvTextEdit"));
        RecvTextEdit->setReadOnly(true);

        horizontalLayout_8->addWidget(RecvTextEdit);

        SendTextEdit = new QTextEdit(horizontalLayoutWidget_2);
        SendTextEdit->setObjectName(QString::fromUtf8("SendTextEdit"));

        horizontalLayout_8->addWidget(SendTextEdit);

        ChangeRange = new QPushButton(centralWidget);
        ChangeRange->setObjectName(QString::fromUtf8("ChangeRange"));
        ChangeRange->setGeometry(QRect(600, 330, 321, 31));
        ChangeRange->setMinimumSize(QSize(20, 31));
        ChangeRange->setFont(font3);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_6->setText(QApplication::translate("MainWindow", "\345\216\213\345\212\233\346\265\213\350\257\225", nullptr));
        ...
        label_7->setText(QApplication::translate("MainWindow", "Pa", nullptr));
        label_range->setText(QApplication::translate("MainWindow", "Pa", nullptr));
        ChangeRange->setText(QApplication::translate("MainWindow", "\351\207\217\347\250\213\345\210\207\346\215\242", nullptr));
    } // retranslateUi
